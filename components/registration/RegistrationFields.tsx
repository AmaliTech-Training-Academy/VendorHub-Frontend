        ...
        >
          <button
            ...
            className={clsx(
              ...
              {
                "bg-white text-blue-900 shadow-sm": selectedRole === "vendor",
                "text-gray-500 hover:text-gray-700": selectedRole !== "vendor",
              },
            )}
          >
            Vendor
          ...
          <button
            ...
            className={clsx(
              "py-2.5 rounded-lg text-sm font-semibold transition-all duration-150",
              {
                "bg-white text-blue-900 shadow-sm": selectedRole === "employee",
