...
export function VendorRegistrationFlow() {
  ...
  return (
    <div className="w-full md:w-1/2 h-full flex flex-col  gap-5 p-5 md:p-12 overflow-y-auto bg-white">
      <div className="w-full max-w-md mx-0 mt-4 md:mt-0">
        {/* Mobile Only Logo Header */}
        <div className="md:hidden mb-6 flex justify-start items-center">
          <Image
            src="/logo.png"
            alt="Logo"
            width={50}
          ...
          />
          <h1 className="text-3xl text-blue-95 font-bold">
